...
[Projets - Votre Penpot - Penpot](https://design.penpot.app/#/dashboard/team/db191280-352c-11ed-9e6a-c67f7655c7b3/projects)

[Phosphor Icons](https://phosphoricons.com/)

[Cool Backgrounds](http://coolbackgrounds.io/)

[Catégories: 😂 Smileys & Emotion Collection Emoji associée | EmojiAll](https://www.emojiall.com/fr/categories/A)
...
[Animista - CSS Animations on Demand](https://animista.net/play/basic/rotate)

[Borderize - Add border to PNG](https://borderize.com/)
...
[CSS Flexbox: A Complete Guide](https://sharkcoder.com/layout/flexbox)
...
[Photo Enhancer | Online One Click Image Enhancer | Fotor Photo Editor](https://www.fotor.com/features/one-tap-enhance)
...
[Optimisation du chargement des ressources avec les conseils de priorité](https://web.dev/priority-hints/)

[direction](https://swiperjs.com/react)

[Color Scales | Components AI](https://components.ai/color-scale/EccrJJBKPtvrI8SVNEhm?tab=editor)

[Color - Components AI](https://components.ai/color/UGPhX5ChTvp8mCfrCrsk)
...
[Hébergement gratuit - Hébergeur gratuit - Nom de domaine gratuit](https://www.planethoster.com/fr/World-Lite)

[GnuWin32 Packages](http://gnuwin32.sourceforge.net/packages.html)

[Oh merde, Git!?!](https://ohshitgit.com/)
...
[Freenom - Un nom pour chacun](https://www.freenom.com/fr/index.html?lang=fr)
...
[Best YAML Validator Online](https://codebeautify.org/yaml-validator)

[Blank Template Facebook Cover - Created with VisMe](https://my.visme.co/editor/aytueUV4THVyeEg3L1ltbUtNNGlCdz09OjrfyrOFen4vjtjBow_82dZr/djdITDUvc3VFd1o0bWl5TEMzWjBtZz09OjroGz_gBJdo1-9p9sTylTlP)
...
[Dokku - The smallest PaaS implementation you've ever seen](https://dokku.com/#install-apt)
...
[Setting Up a Modern PHP Development Environment with Docker - SitePoint](https://www.sitepoint.com/docker-php-development-environment/)

[readme.so - Easiest Way to Create A README](https://readme.so/fr)

[HTML Code - 𝗢𝗡𝗟𝗜𝗡𝗘 𝗪𝗘𝗕 𝗗𝗘𝗩𝗘𝗟𝗢𝗣𝗘𝗥 𝗧𝗢𝗢𝗟𝗦](https://html-css-js.com/html/)

[Woff2Base: Convert .woff2 to accurate Base64 css.](https://hellogreg.github.io/woff2base/)

[Ojoy](https://ojoy.zaps.dev/)

[Method Draw Vector Editor](https://editor.method.ac/)

[umami](https://umami.is/?source=korben.info)

[How to setup continuous deployment of a website on a VPS using GitHub Actions - DEV Community](https://dev.to/knowbee/how-to-setup-continuous-deployment-of-a-website-on-a-vps-using-github-actions-54im)

[Canarytokens](https://canarytokens.org/generate)

[Pixelhunter — 🧠 AI-powered image resizer for social media](https://pixelhunter.io/?source=korben.info)
...
[dpskvn/express-sse: An Express middleware for quick'n'easy server-sent events.](https://github.com/dpskvn/express-sse)

[Les patrons de conception en PHP](https://refactoring.guru/fr/design-patterns/php)

[Quick Start | React Query | TanStack](https://react-query.tanstack.com/quick-start)

[Slax Linux - your pocket operating system](https://www.slax.org/)

[AI Doc Writer for Python, JavaScript, TypeScript, C, C++, PHP, and Java - Visual Studio Marketplace](https://marketplace.visualstudio.com/items?itemName=mintlify.document)

[DiceBear Avatars](https://avatars.dicebear.com/)

[CSS Animations Generator | Web Code Tools](https://webcode.tools/generators/css/keyframe-animation)

[lightGallery React - lightGallery](https://www.lightgalleryjs.com/docs/react/#installation)

[Retro Comic Text Effect · InkPx](https://inkpx.com/word-art-generator/retro-comic-text-effect)

[datetime.tools](https://datetime.tools/formats)
...
[goldfire/howler.js: Javascript audio library for the modern web.](https://github.com/goldfire/howler.js#documentation)

[Migrate from Tailwind CSS | Windi CSS](https://windicss.org/guide/migration.html)

[Mantine](https://mantine.dev/)

[Pare-feu](https://guide.ubuntu-fr.org/server/firewall.html)

[NodeJS et Nginx — Formation Mettre en place un serveur Web | Grafikart](https://grafikart.fr/tutoriels/nodejs-nginx-960)

[Forms - Unpoly](https://unpoly.com/up.form)

[Certbot Instructions | Certbot](https://certbot.eff.org/instructions?ws=nginx&os=ubuntufocal)

[Stitches — CSS-in-JS with near-zero runtime](https://stitches.dev/)

[Hama](https://www.hama.app/)

[amark/gun: An open source cybersecurity protocol for syncing decentralized graph data.](https://github.com/amark/gun)
...
[workspace :: Git Cheatsheet :: NDP Software](https://ndpsoftware.com/git-cheatsheet.html#loc=workspace;)

[vadimdemedes/ink : 🌈 React pour les applications interactives en ligne de commande](https://github.com/vadimdemedes/ink#usestdin)

[Cheat sheet Git](https://david-mi.github.io/cheatsheet_git/#checkout)

[TypeScript Tutorials](https://www.logicbig.com/tutorials/misc/typescript.html)

[Et merde, Git!?!](https://ohshitgit.com/fr)

[Postimages — hébergement gratuit d'images / hébergement de photos](https://postimages.org/)
...
[expo/expo: An open-source platform for making universal native apps with React. Expo runs on Android, iOS, and the web.](https://github.com/expo/expo)

[839 Best Landing Page Design Inspiration & Examples | Landingfolio](https://landingfolio.com/inspiration/landing-page)
...
[SQL Cheat Sheet Download PDF it in PDF or PNG Format](https://www.sqltutorial.org/sql-cheat-sheet/)
...
[Check-list Qualité Web : la checklist de référence](https://checklists.opquast.com/fr/assurance-qualite-web/)
...
[Editor | TOAST UI :: Make Your Web Delicious!](https://ui.toast.com/tui-editor)
